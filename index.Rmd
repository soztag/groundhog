...
### Factor 1 **civil and law-abiding**  
Factor 1 has an 1eigenvalue of 8.80 and explains 24.4% of the stury variance.  
Most of the participants of our sample are significantly associated with this factor. Hence, the item standard deviation across the Q sort for this factor is relatively high in comparison to the others, especially at the extremes.
  
People who load highly on factor 1 show a tendency of healthy curiosity.  
They strive to experiment with things that only concerns themselves in the broadest sense. Besides memorizing the lottery numbers (+7) and placing some financial insider trades in the re-run, profiting from my knowledge of the future (+6), which are actions to provide for their livelihood security in 'real life' and time after the groundhog scenery and therefore for their future, they see their opportunity to do things they would like to do on everyday life but cannot because they do not have the time or courage to do so, e.g. having more me time (+4) and to improve themselves (+4), confess something they have never told anyone (+3) and live out sexual fantasies (+2).

They would still, however, behave and act within the frame of social norms and values. They shun breaking the law and actions that could harm any other individual or institution. There are indications that leads to the assumption that they avoid these actions not particularly because they are still afraid of the consequences, but rather because they can not find a sense in arbitrary destruction (-5) or affecting somebody detrimentally, as they are not drawn to “Making someone else's day as horrible as possible” (-4) or faking their own deaths (-4), which both would result in distressing the peolpe, who are involved, either. Consequently, the item “Killing someone” (-7) is placed on the negative extreme point; even though not everyone with loadings on factor 1 seems to fully agree on the total ranking, as the standard deviation indicates, the sort indicates that ruthless behavior in general is to be avoided. 

This group of participants can be described as **civil and law-abiding** in the sense of not wanting to attract attention to themselves by illicit actions but still see their chance to take advantage of the situation and to try new things and be adventurous to a certain degree, without sabotaging anyone else or themselves by doing so.  
Nonetheless, it should be keep in mind that this cluster is the factor that is most likely influenced and shaped by *social desirability*.



### Factor 2 **antisocial and freedom-loving**  
Factor 2 has an eigenvalue of 4.34 and explains 12.1% of the study variance.  
Few people have significantly high loadings on this factor.  
  
People with loadings on factor 2 tend to test the extremes that are usually socially stigmatized in a negative way.  
They are characterized by **reckless and regardless behavior** in a sense of discarding social constraints. Given the opportunity a week where they can do whatever they want, without living with the consequences afterwards, they go to the limits, in comparison to the participants of the other factors. As a result, they vigorously avoid doing the usual (-7), act normally (-5), and get some work done (-5) the most. They feel also less averse to the idea of general and public destruction, which shows in rather positive tendencies towards destructive and violent behavior (0), burning down state facilities (+1), Grand Theft Auto in real life (+1) and robbing a bank (+4). 

Besides activities and behavior, which do not principally aims at, but involves inflicting damage on individuals or society, they seem to deliberately shun social actions as interpersonal interaction, as by throwing a huge party (-3), pretending to be someone else (-4) or with cheating (-4).
Even though they seem to feel negative about the item “Avoid people I know because the would remember out meeting” (-3), this can either be explained by assuming that they do not call much importance to the underlying tone of the item of getting in an uncomfortable situation with those people after the groundhog week or that their circle of friends and acquaintances they meet on a regular basis is not big enough to care about this problematic or they do not meet anyone that often at all. 

Nevertheless, it is important to emphasize, that the principles of this factor are not primarily to harm and to destruct, but they hazard these consequences in doing what they want to do and experience out of their curiosity. One could say, the end justifies the means here. Hence, the item "Being destructive and violent" (0) is placed in the middle, implying indifference, meaning they do not especially feel positive or negative about it, it might not be a "must do", however, they would not despise it and avoid it out of conviction as participants with higher loadings on factor 1 would.

This group of people use their new gained opportunity to think completely outside the box, and do the extremes they usually cannot implement or accomplish because they are normally restricted by social desirability and restriction and criminal prosecution.



### Factor 3 **adventurous and eclectic**
Factor 3 has an eigenvalue of 2.46 and explains 6.84% of the study variance.  
Only three participants can be significantly associated with this factor, who are all male and in the age og 20 to 23. The item standard deviation of this factor is, therefore, relatively low.
  
People, who load highly on factor 2, belong to the most ambivalent group of the participants.  
They feel positive about the opportunity to cheat (+7) and to tell other people their true opinion (+6). An item they also place on a highly positive rank is “Just do completely random stuff, whatever comes to mind” (+5) which pretty much explains and summarizes the mindset and reasoning of this cluster. On the one hand they consider robbing a bank (+3), which demands much effort and energy; on the other hand they can also imagine sleeping the whole day (+5).

They seem indecisive but also, or rather *because*, they can easily be enthused for everything. However, they draw the line at being destructive and violent (-5) and killing somebody (-4), as people with high loadings of factor 1 do, but also avoid particularly acting normally (-4), agreeing with people from factor 2. On the first sight this group of **eclectic experimentalists** might seem like a combination or something in-between the factor 1 and 2 but on further inspection there are completely different motivations behind their choices. For example, they dislike the idea of killing somebody random (-4) and being destructive and violent (-5), however, like the idea to rob a bank (+3), which are items that people with high loadings of factor 1 and factor 2 seem not distinguish in particular.

The group with high loadings on factor 3 think more **pragmatically** though. The sort of factor 3 shows that items as “Make myself deaf or blind, so I can learn how it is to live like that.” (-7) and “Kill myself to see what happens after death” (-6) and the destructive behavior and killing somebody, as mentioned above, are things that they feel negative about and would not consider, not because these actions chiefly anticipate their moral values, but rather because this behavior would or could restrict them in their further plans for the groundhog week, as they could be send to jail or simply cannot experience anything different fully with all their senses anymore. According to their sorting they do not have a strict moral code or specific values they live to but rather elect their morals according to what they want to achieve.

The statistical outcome and the fact that only a low number of participants can be significantly associated with this factor, might give room for concerns about its eligibility, however using not only the quantitive but also the qualitive character of Q method, it is possible to reason a pattern and subjectivity behind this factor, that might have seen arbitrar at first, and give it solid ground.
